...
#define LED_STATUS_BLINK_FAST() do { \
    ...
    system("echo 100 > /sys/class/leds/ledsw2\\:red/delay_off"); \
} while(0)
...
#define LED_STATUS_BLINK_80_1s() do { \
    system("echo 0 > /sys/class/leds/ledsw2\\:red/brightness"); \
    system("echo timer > /sys/class/leds/ledsw2\\:red/trigger"); \
    system("echo 800 > /sys/class/leds/ledsw2\\:red/delay_on"); \
    system("echo 200 > /sys/class/leds/ledsw2\\:red/delay_off"); \
} while(0)

#define LED_STATUS_BLINK_20_1s() do { \
    system("echo 0 > /sys/class/leds/ledsw2\\:red/brightness"); \
    system("echo timer > /sys/class/leds/ledsw2\\:red/trigger"); \
    system("echo 200 > /sys/class/leds/ledsw2\\:red/delay_on"); \
    system("echo 800 > /sys/class/leds/ledsw2\\:red/delay_off"); \
} while(0)
...
#define DEVICE_STATUS_COMPRESS()            LED_STATUS_BLINK_80_1s()
#define DEVICE_STATUS_UPLOAD()              LED_STATUS_BLINK_20_1s()
