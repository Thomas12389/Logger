...
void CTimer::StartOnce(CTimer::Clock::duration timeout)
{
...
void CTimer::StartPeriodicImmediate(CTimer::Clock::duration period)
{
    std::unique_lock<std::mutex> lock(mutex_);
    mode_ = kPeriodic;
...
void CTimer::StartPeriodicDelayed(CTimer::Clock::duration delayperiod, CTimer::Clock::duration period)
{
    std::unique_lock<std::mutex> lock(mutex_);
    mode_ = kPeriodic;
