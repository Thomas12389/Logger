...
public:
     ...
     * fires.
     */
    void StartOnce(Clock::duration timeout);

    /**
     * \brief Start a periodic timer that fires immediately.
     */
    void StartPeriodicImmediate(Clock::duration period);

    /**
     * \brief Start a periodic timer that first fires after one period has passed.
     */
    void StartPeriodicDelayed(Clock::duration delayperiod, Clock::duration period);
